...
public class JourneyHistoryAdapter2 extends ArrayAdapter<JourneyHistory> {

    public JourneyHistoryAdapter2(@NonNull Context context, List<JourneyHistory> historyList) {
